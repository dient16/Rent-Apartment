...
const Search: React.FC = () => {
    ...
    return (
        <form
            ...
            className="max-w-[920px] w-full min-h-[100px] bg-white rounded-3xl mt-[30px] flex justify-start items-center px-10 gap-5 flex-wrap py-10 lg:rounded-full lg:shadow-card-lg"
        >
            <Controller
                control={control}
                name="searchText"
